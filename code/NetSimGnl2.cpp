...
void NetSimGnl2::RunInit(int thNum,int sop)
{
...
void NetSimGnl2::SimThd(unsigned int thid)
{
...
//build up noise
  ...
  else
  {
    ...
    { th[i] = thread(&NetSimGnl2::SimThd,this,i); }
